export default function Footer() {
    return(
        <div className="w-[550px] sm:w-[1220px] px-12 sm:px-0 mx-auto pb-12 rounded-lg pt-44">
            <div className="max-w-screen-xl px-6 w-[550px] sm:w-full sm:mx-auto md:py-2">
                <div className="flex items-center justify-between py-2">
                    ...
                    <ul className="flex flex-wrap items-center  text-sm font-medium text-gray-600 sm:mb-0 dark:text-gray-400">
                        ...
                        <li>
                            <a href="https://www.instagram.com/amicos_mutual/" className="text-gray-800 hover:opacity-80 me-4 md:me-6 flex align-bottom">
                            Instagram
                            </a>

                        </li>
                        <li>
                            <a href="https://mail.google.com/mail/u/0/#inbox?compose=jrjtXDxqxtnRDWvxvjCRskvHxBBbtQrFZxkZvxVnvZHJcMgnTFxqsncsfpkgWVdjxkgkTvKg" className="text-gray-800 hover:opacity-80">
                            Gmail
                            </a>
                        </li>
                    </ul>
            ...
            <div className="grid grid-cols-1  sm:grid-cols-2 mx-auto w-[550px] sm:w-full">
                <div className="text-gray-700">
                    <p className="flex justify-center sm:justify-start">Asociación Mutual Intercooperativa Solidaria.</p>
                    <p className="flex justify-center sm:justify-start">C.U.I.T. 30-68761473-5</p>
                    <p className="flex justify-center sm:justify-start">Mat. I.N.A.C.Y.M. Nº 680</p>
                    <p className="flex justify-center sm:justify-start">N° de Inscripción RNEMP: 9999 | Superintendencia de Servicios de Salud.</p>
                </div>
                <div className="text-gray-700 inline-flex sm:ml-12 sm:pl-0 justify-center sm:justify-end gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" className="icon icon-tabler icons-tabler-outline icon-tabler-map-pin" viewBox="0 0 24 24"><path stroke="none" d="M0 0h24v24H0z"/><path d="M9 11a3 3 0 1 0 6 0 3 3 0 0 0-6 0"/><path d="M17.657 16.657 13.414 20.9a2 2 0 0 1-2.827 0l-4.244-4.243a8 8 0 1 1 11.314 0z"/></svg>
