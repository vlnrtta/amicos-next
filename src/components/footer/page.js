export default function Footer() {
    return(
        <div className="w-[550px] sm:w-[1220px] px-12 sm:px-0 mx-auto pb-12 rounded-lg pt-44">
            ...
            <div className="grid grid-cols-2 mx-auto w-[550px] sm:w-full">
                ...
                <div className="text-gray-700 inline-flex ml-12 sm:pl-0 justify-end gap-2">
                    ...
                    <h5 className="justify-end">San Luis 71 - Nueva Cordoba - Cordoba.</h5>
                </div>
            </div>
        </div>
    );
