...
export default function Nosotros() {
    return(
        <div>
            ...
            <div className="mt-24 p-4 mx-8 px-8 sm:p-4 sm:mx-24 leading-normal  rounded-2xl shadow-2xl shadow-gray-800 h-full">
